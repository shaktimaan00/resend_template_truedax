...
const baseUrl = 'https://demo.react.email/preview/github-access-token?view=source';
...
export const GithubAccessTokenEmail = ({
  ...
  <Html>
    <Head />
    <Preview>
      A fine-grained personal access token has been added to your account chigga
    </Preview>
    <Body style={main}>
